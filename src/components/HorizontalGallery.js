...
const HorizontalGallery = ({ galleryItems }) => (
  <div>
    <h3 css={{ marginBottom: "10px" }}>For pricing or more information on any available instruments please contact me</h3>
    <ContactLink href="tel:718-344-8587">Phone: 718-344-8587</ContactLink>
    <ContactLink href="mailto:bairdguitars@gmail.com">Email: bairdguitars@gmail.com</ContactLink>
    <div
      css={{
        display: "flex",
